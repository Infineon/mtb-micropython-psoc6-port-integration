...
MPY_TOP_DIR = ../..
MPY_PSOC6_PORT_DIR = $(MPY_TOP_DIR)/ports/psoc6

ifeq ($(MICROPY_PY_SSL),1)
MBEDTLS_CONF_DIR = $(MPY_PSOC6_PORT_DIR)/mbedtls
MBEDTLS_MPY_CONF_DIR = $(MPY_TOP_DIR)/extmod/mbedtls $(MPY_TOP_DIR) $(MPY_PSOC6_PORT_DIR) $(MPY_PSOC6_PORT_DIR)/boards/$(BOARD)
